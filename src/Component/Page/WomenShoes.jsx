    ...
    return (
        <div className='bg-[#e8ebe2] border border-b-black'>
            <div className="flex justify-center items-center mt-5 ">
                <h1 className="text-3xl text-black font-semibold underline underline-offset-8 ">Women Shoes <span className="text-blue-500">Products</span></h1>
            </div>


            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 mt-10 ">

                {womenProducts.length > 0 &&(womenProducts.map(product =>(<Card key={product.id}
                name={product.name}
                brand={product.brand}
                price={product.price}
