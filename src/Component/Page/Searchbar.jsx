...
export default function Searchbar() {
  return (
    <div>
        <div class="flex rounded-md border border-blue-500 overflow-hidden max-w-md mx-auto">
        <input type="email" placeholder="Search Something..."
          class="w-full outline-none bg-white text-gray-600 text-sm px-5 py-1 sm:px-1" />
